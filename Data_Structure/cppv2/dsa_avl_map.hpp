...
public:
  ...
  public:
    explicit _node(K k = NULL, V v = NULL, _node *l = nullptr,
                   _node *r = nullptr, unsigned int h = 1)
...
public:
  explicit dsa_avl_map() : _root(nullptr), _size(0) {}
...
public:
  ...
  bool balanced() { return balanced(_root); }

  bool balanced(_node *cur) { return abs(balance_factor(cur)) <= 1; }

  bool contains(K _key) { return get_node(_root, _key) != nullptr; }
  ...
  void add(K _key, V _val) { _root = add(_root, _key, _val); }
